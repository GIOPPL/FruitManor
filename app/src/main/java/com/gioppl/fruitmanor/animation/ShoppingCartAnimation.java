package com.gioppl.fruitmanor.animation;
...
public class ShoppingCartAnimation {
    ...
    private int mCenterY = 300;
    private int duration = 500; // 毫秒
    private ImageView goodsImg;

    public ShoppingCartAnimation(Context context) {
    ...
    public void addGoodsToCart(ImageView goodsImg, final View startView, final View endView) {
