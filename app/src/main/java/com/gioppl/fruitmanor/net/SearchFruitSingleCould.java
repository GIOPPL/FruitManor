...
public class SearchFruitSingleCould {
    private NetData mCircleData;
    private Context mContext;
    private ArrayList<NetFruitBean> beanList;

    public SearchFruitSingleCould(Context mContext,String objectId, NetData mData){
        this.mContext=mContext;
        this.mCircleData=mData;
        getNetDate(objectId);
    }

    public  void getNetDate(String objectId){
        String cql="select * from Fruit where objectId = '"+objectId+"'";
